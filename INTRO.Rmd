...
Statistics is about making sense of data. Therefore understanding statistics requires starting with an understanding of data types. 
...
R is an open source project, and new packages are being added all the time, there are millions of ways to accomplish the same task. 
...
Learn to use R scripts- and save the R script frequently!! This is the primary record of what you've done and allows you and other scientists to reproduce your workflows.
