...
Pretty much all of classical statistics works this way. We compute summary statistics from data that have well-described sampling distributions. We climb into the null universe and, using the known sampling distribution, inquire whether or not our summary statistic (computed from our data) could have been a result of random sampling error under the null hypothesis. If not (if $p\ge\alpha$) then we remain unconvinced that the null universe is indeed false. 
...
**PDF** - Probability density function (e.g., 'dnorm')

**CDF** - Cumulative distribution function (e.g., 'pnorm')

**Quantiles** - inverse of CDF- the values below which x percent of the data lie (e.g., 'qnorm') 
