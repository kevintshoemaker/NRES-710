...
Pairwise comparisons for two-way ANOVA are similar to in one-way ANOVA- you just have to specify which categorical predictor variable you want to run pairwise comparisons for! And if you want to look at interactions, you might consider using the 'emmeans' function in the 'emmeans' package
