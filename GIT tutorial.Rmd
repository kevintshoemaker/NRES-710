...
3. Install VS Code text editor from [https://atom.io/](https://code.visualstudio.com/). This is a powerful source text editor for coding that enables (among many other things) streamlined solutions for resolving merge conflicts in Git.
