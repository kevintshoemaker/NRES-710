...
The *t distribution* is the theoretical sampling distribution for the t-statistic under the null hypothesis. It describes the distribution of "false signals" that can arise under the null hypothesis, caused by random sampling. 
...
Let's face it. T-tests, are more commonly used than z-tests for data analysis. The reason: we usually don't know the population mean or standard deviation. All we have is the sample!
...
For the t-test, we should test for normality of the data (or the paired differences, or test separately for each of the two groups).
